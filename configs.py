...
neo_config.setIdleMode(SparkBaseConfig.IdleMode.kCoast). \
    smartCurrentLimit(10)
neo_config.closedLoop.   \
    setFeedbackSensor(ClosedLoopConfig.FeedbackSensor.kPrimaryEncoder). \
    pid(0.0, 0.0, 0.0).  \
    velocityFF(0.00045). \
    outputRange(-1, 1)
neo_config.closedLoop.maxMotion.maxVelocity(700). \
...
driving_config.setIdleMode(SparkMaxConfig.IdleMode.kBrake). \
...
driving_config.closedLoop. \
    ...
    outputRange(-1.0, 1.0)
driving_config.closedLoop.maxMotion. \
    maxVelocity(10).                 \
    maxAcceleration(20).             \
    allowedClosedLoopError(0.01)

turning_config.setIdleMode(SparkMaxConfig.IdleMode.kBrake). \
...
turning_config.closedLoop.maxMotion. \
    maxVelocity(10).                 \
    maxAcceleration(20).             \
    allowedClosedLoopError(0.01)