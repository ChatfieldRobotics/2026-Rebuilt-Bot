...
class RobotContainer:
    ...
    def set_controller_bindings(self):
        self.robot_drive.queue_state(("drive", {
            "driver_controller": self.driver_controller,
            "field_relative": False
        })) 
        
        self.driver_controller.a().onTrue(lambda: self.intake_subsystem.queue_state(("run_intake", {"speed": 0.6})))
        self.driver_controller.a().onFalse(lambda: self.intake_subsystem.queue_state(("run_intake", {"speed": 0.0})))